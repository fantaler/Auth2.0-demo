...
public class ServerController{
	...
	public String requestServerFirst(HttpServletRequest request, HttpServletResponse response, RedirectAttributes attr) throws OAuthProblemException{
	    ...
	    redirectUrl = "http://localhost:8080/authclient/server/callbackCode";
	    response_type = "code";
		...
		return "redirect:http://localhost:8081/authserver/"+requestUrl ;
	}
	...
	public Object toLogin(HttpServletRequest request) throws OAuthProblemException{
		...
		clientId = "clientId";
		clientSecret = "clientSecret";
		accessTokenUrl="http://localhost:8081/authserver/responseAccessToken";
	    userInfoUrl = "userInfoUrl";
	    redirectUrl = "http://localhost:8080/authclient/server/accessToken";
	    ...
	    try {
            ...
            return "redirect:http://localhost:8080/authclient/server/accessToken?accessToken="+accessToken;
		} catch (OAuthSystemException e) {
			e.printStackTrace();
		}
	    return null;
	...
	public ModelAndView accessToken(String accessToken) {
		...
		userInfoUrl = "http://localhost:8081/authserver/userInfo";
		OAuthClient oAuthClient = new OAuthClient(new URLConnectionClient());
